    ...
    <div className='prompt_card'>
        ...
        pathName === '/profile' && (
            <div className='mt-5 flex-center gap-4 border-gray-100 pt-3'>
                <p
                className='font-inter text-sm orange_gradient cursor-pointer' onClick={handleEdit} >
                    Edit
                </p>
                <p
                className='font-inter text-sm green_gradient cursor-pointer' onClick={handleDelete} >
                    Delete
                </p>
            </div>
        )}
